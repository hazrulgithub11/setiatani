        ...
        <div className="flex flex-col items-center gap-10 md:flex-row md:items-stretch md:gap-12">
          ...
          <div className="relative w-full shrink-0 overflow-hidden rounded-sm md:w-[52%]">
            ...
            <div
              ...
              aria-hidden="true"
            >
              {/* Setia Tani wordmark on the thumbnail */}
            ...
            <button
              ...
              aria-label="Play Setia Tani company video"
            >
          ...
          <div className="flex flex-col justify-center md:w-[48%]">
            ...
            <p className="mt-6 text-sm leading-relaxed text-gray-600">
              Our strategic focus on our three pillars of growth, namely{" "}
              {/* Key phrase is bold as in the screenshot */}
              <strong className="font-semibold text-gray-800">
                Sustainable Farming, Processing Excellence, and Market Expansion
              </strong>
              , drives our mission to deliver premium palm oil products at
